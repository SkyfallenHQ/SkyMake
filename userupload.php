...
require_once "SkyMakeDBConnector/SkyMakeDBconfig.php";
...
$sql = "INSERT INTO skymake_useruploads (upload_id,uploadlink) VALUES ('".$upload_id."','".$uploadlink."')"
if($result = mysqli_query($link, $sql)){
    echo "SQL Query successfully executed.";
    if($_POST["aasc"] == "yes"){
    $sql = "INSERT INTO skymake_lessoncontent (lessonid,`content-type`,`content-id`,`content-link`) VALUES ('".$lessonid."','Document','".$upload_id."','"."/".$uploadlink."')"
    if($result = mysqli_query($link, $sql)){
        echo "SQL Query successfully executed.";
